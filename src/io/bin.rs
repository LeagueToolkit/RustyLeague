...
impl BinEntry {
    ...
    pub fn values(&self) -> &Vec<BinValue> {
        &self.values
    }
...
impl BinStructure {
    ...
    pub fn fields(&self) -> &Vec<BinValue> {
        &self.fields
    }
...
impl BinMap {
    ...
    pub fn key_type(&self) -> BinValueType {
        self.key_type
    }
    pub fn value_type(&self) -> BinValueType {
        self.value_type
    }
    pub fn map(&self) -> &HashMap<BinValue, BinValue> {
        &self.map
    }
